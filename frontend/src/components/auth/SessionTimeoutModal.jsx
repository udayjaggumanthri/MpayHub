...
const SessionTimeoutModal = ({ code = 'SESSION_IDLE', onLogin }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[420px] overflow-hidden rounded-2xl bg-white px-8 pb-8 pt-10 text-center shadow-2xl shadow-slate-900/20 ring-1 ring-black/5 animate-fadeIn">
        ...
        <div className="relative mx-auto mb-6 flex h-24 w-28 items-center justify-center" aria-hidden>
          <div className="absolute inset-x-4 bottom-1 h-3 rounded-full bg-blue-100/90 blur-[1px]" />
          <div className="relative flex h-16 w-20 items-end justify-center">
            <div className="relative h-14 w-16 rounded-[1.35rem] bg-gradient-to-b from-blue-100 to-indigo-50 ring-1 ring-blue-200/80">
          ...
          <span className="absolute -right-1 top-6 select-none text-[15px] font-bold tracking-widest text-blue-600">
            Z
          </span>
        </div>
        ...
        <p
          ...
          className="mx-auto mt-3 max-w-[20rem] text-[15px] leading-relaxed text-slate-500"
        >
          {message}
        </p>
