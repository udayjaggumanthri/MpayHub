...
urlpatterns = [
    ...
    path('onboarding/image/<str:field>/', views.onboarding_image, name='aeps-onboarding-image'),
    ...
    path('admin/debug-logs/<int:log_id>/', views.admin_debug_log_detail, name='aeps-admin-debug-log-detail'),
    ...
    path('admin/merchants/<int:merchant_id>/', views.admin_merchant_detail, name='aeps-admin-merchant-detail'),
    path(
        'admin/merchants/<int:merchant_id>/reset-pin/',
        views.admin_merchant_reset_pin,
        name='aeps-admin-merchant-reset-pin',
    ),
